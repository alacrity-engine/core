...
func (avl *AVLUnrestrictedSortedDictionary[TKey, TValue]) VisitInOrder(visit func(key TKey, value TValue) error) error {
	return avl.tree.VisitInOrder(func(node *UnrestrictedAVLNode[TKey, TValue]) error {
